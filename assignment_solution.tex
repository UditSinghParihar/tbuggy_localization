...
% TODO: Insert RViz screenshot showing feature tracks + live VIO path overlaid on GT
% Suggested filename: utils/results/rviz_log01.png
% Placeholder size below reserved; remove the \vspace and add:
%   \includegraphics[width=\textwidth]{rviz_log01.png}
%   \caption{RViz2 --- OpenVINS feature tracks (green) and live path estimate vs GT (white).}
\begin{figure}[H]
  \centering
  \framebox[\textwidth]{\parbox[c][4.5cm][c]{\dimexpr\textwidth-2\fboxsep-2\fboxrule}{%
    \centering\color{gray}
    \textbf{\% TODO: RViz screenshot}\\[4pt]
    Capture from RViz2 while OpenVINS runs on log\_01.\\
    Shows: feature tracks (green points), live path estimate vs GT.\\
    Save as \texttt{utils/results/rviz\_log01.png} and replace this box with:\\
    \texttt{\textbackslash includegraphics[width=\textbackslash textwidth]\{rviz\_log01.png\}}
  }}
  \caption{RViz2 view --- RESERVED for user-captured screenshot during OpenVINS run.}
\end{figure}
